...
const styles = ['./window.css', './styles/sidebar.css', './styles/setting.item.css', './styles/ui.css', './styles/index.css'];
const fonts = {
...
const loadingSpinner = document.createElementNS("http://www.w3.org/2000/svg", "svg");
